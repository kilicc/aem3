...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "text-base sm:text-lg md:text-lg lg:text-lg xl:text-xl font-semibold leading-none tracking-tight",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn("text-sm sm:text-xs md:text-sm lg:text-sm xl:text-sm text-muted-foreground", className)}
    {...props}
  />
));
